...
public class DoctorMainView extends JFrame {
	...
	private JButton btn_diagnosis =null;//病情诊断按钮
	private JButton btn_record = null;//记录查询按钮
	...
	private void init() {
		...
		btn_diagnosis = new JButton("病情诊断");
		btn_diagnosis.setFont(new Font("宋体",Font.BOLD,20));
		btn_record = new JButton("记录查询");
		btn_record.setFont(new Font("宋体",Font.BOLD,20));
		...
		lb_welcome = new JLabel("欢  迎 "+doctor.getName()+" 使  用  诊  断  系  统");
